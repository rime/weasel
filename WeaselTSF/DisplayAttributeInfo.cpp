...
STDAPI CDisplayAttributeInfoInput::QueryInterface(REFIID riid, _Outptr_ void** ppvObj)
{
    if (ppvObj == nullptr)
        return E_INVALIDARG;
...
STDAPI CDisplayAttributeInfoInput::GetAttributeInfo(_Out_ TF_DISPLAYATTRIBUTE* ptfDisplayAttr)
{
...
STDAPI CDisplayAttributeInfoInput::SetAttributeInfo(_In_ const TF_DISPLAYATTRIBUTE* /*ptfDisplayAttr*/)
{
    return E_NOTIMPL;
}
