...
ibus::Keycode TranslateKeycode(UINT vkey, KeyInfo kinfo)
{
	...
	case VK_NUMPAD0:	return ibus::KB_0;
	case VK_NUMPAD1:	return ibus::KB_1;
	case VK_NUMPAD2:	return ibus::KB_2;
	case VK_NUMPAD3:	return ibus::KB_3;
	case VK_NUMPAD4:	return ibus::KB_4;
	case VK_NUMPAD5:	return ibus::KB_5;
	case VK_NUMPAD6:	return ibus::KB_6;
	case VK_NUMPAD7:	return ibus::KB_7;
	case VK_NUMPAD8:	return ibus::KB_8;
	case VK_NUMPAD9:	return ibus::KB_9;
