...
LangString LNKFORSYNC ${LANG_ENGLISH} "[Weasel] User Profile Sync"
...
LangString LNKFORUPDATER ${LANG_ENGLISH} "[Weasel] Check Update"
LangString LNKFORSETUP ${LANG_ENGLISH} "[Weasel] Setup"
