target("TestResponseParser")
  set_kind("binary")
  add_files("./*.cpp")
  add_files("../../WeaselServer/AssistantGateway.cpp")
  add_files("../../WeaselServer/AssistantPolicy.cpp")
  add_files("../../WeaselServer/CredentialStore.cpp")
  add_files("../../WeaselServer/ProviderAdapters/*.cpp")
